...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; text-decoration: none; border: none; outline: none; }
        ...
        .row { display: flex; align-items: center; width: 100%; min-height: 600px; margin: 0; padding: 50px 0; }
        ...
        .f-glass { max-width: 480px; margin: 0 auto; padding: 40px; background: rgba(255,255,255,0.02); border-radius: 20px; }
    ...
    <div class="product-section sauv-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                ...
                <h3>The Fragrance</h3>
                <p class="desc-full">Sauvage Elixir is an extraordinarily concentrated fragrance steeped in the iconic freshness of Sauvage with an intoxicating heart of spices, a custom-composed lavender essence and a blend of rich woods.</p>
                <ul class="specs-list">
                    <li><b>For:</b> Him</li>
                    <li><b>He Is:</b> Strong & Wild</li>
                    <li><b>Occasion:</b> Night & Special</li>
                    <li><b>Family:</b> Aromatic Fougere</li>
                </ul>
            </div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full">
                    ...
                    <p><b>Top Notes:</b> Grapefruit, Spices</p>
                    <p><b>Heart Notes:</b> Lavender</p>
                    <p><b>Bottom Notes:</b> Amber, Patchouli, Vetiver</p>
                </div>
            </div>
        </div>
        <div class="f-wrap"><form class="f-glass"><input type="text" placeholder="الاسم الكامل" class="in-f" required><input type="tel" placeholder="رقم الهاتف" class="in-f" required><button type="submit" class="btn-f">احجز الآن | 319 DH</button></form></div>
    </div>
    ...
    <div class="product-section stron-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                <div class="glow-effect"></div>
                <h3>The Fragrance</h3>
                <p class="desc-full">Stronger With You lives in the present, molded by the energy of modernity. Unpredictable, he surprises with his originality, like the spicy accord in the top notes.</p>
                <ul class="specs-list">
                    <li><b>For:</b> Him</li>
        ...
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full">
                    ...
                    <p><b>Top Notes:</b> Mint, Violet Leaf</p>
                    <p><b>Heart Notes:</b> Sage, Pineapple</p>
                    <p><b>Bottom Notes:</b> Cedar, Amberwood</p>
                </div>
            </div>
        </div>
        <div class="f-wrap"><form class="f-glass"><input type="text" placeholder="الاسم الكامل" class="in-f" required><input type="tel" placeholder="رقم الهاتف" class="in-f" required><button type="submit" class="btn-f">احجز الآن | 319 DH</button></form></div>
    ...
    <div class="product-section libre-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                <div class="glow-effect"></div>
                <h3>The Fragrance</h3>
                <p class="desc-full">Libre: the new fragrance of freedom, a statement fragrance for those who live by their own rules. A floral lavender fragrance, sensual and cool.</p>
                <ul class="specs-list">
                    <li><b>For:</b> Her</li>
                    <li><b>She Is:</b> Free & Bold</li>
                    <li><b>Occasion:</b> Evening</li>
                    <li><b>Family:</b> Oriental Floral</li>
                </ul>
            </div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full">
                    ...
                    <p><b>Top Notes:</b> Neroli, Mandarin</p>
                    <p><b>Heart Notes:</b> Jasmine, Lavender</p>
