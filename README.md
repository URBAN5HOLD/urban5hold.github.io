...
<head>
    ...
    <style>
        ...
        * { 
        ...
        /* السهم الجديد: هابط بـ 30% كتر ومن غير دوارة */
        .scroll-trigger { 
            position: fixed; top: 75%; right: 25px; /* هبطتو للمنطقة السفلية المريحة */
        ...
        /* تأثير الضبابة الحر (بدون مربعات) */
        .text-glow-free {
            position: relative; 
            z-index: 2;
            padding: 20px;
            /* هاد الكود هو اللي كيحيد المربع وكيدير ضبابة دائرية حرة */
            background: radial-gradient(ellipse at center, var(--glow-color) 0%, rgba(0,0,0,0) 80%) !important;
        }
        ...
        .txt-box p { font-size: 0.95rem; line-height: 1.9; color: #f0f0f0 !important; font-weight: 300; margin-bottom: 15px; }
        ...
        @media (max-width: 900px) {
            ...
            .text-glow-free { background: radial-gradient(circle at center, var(--glow-color) 0%, rgba(0,0,0,0) 90%) !important; }
        }
...
<body>
    ...
    <section class="product-section sauv-t" id="sec1">
        ...
        <div class="row">
            ...
            <div class="txt-box"><div class="text-glow-free">
                ...
                <p><span class="highlight">Pour :</span> Lui<br><span class="highlight">Caractère :</span> Puissant et Noble</p>
            </div></div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box"><div class="text-glow-free">
                ...
                <p><span class="highlight">Tête :</span> Pamplemousse & Épices<br><span class="highlight">Cœur :</span> Lavande de Nyons AOP<br><span class="highlight">Fond :</span> Bois de Santal</p>
            </div></div>
        </div>
    </section>

    <section class="product-section libre-t" id="sec2">
        <div class="glow-center"></div>
        ...
        <div class="row rev">
            <div class="img-box"><img src="assets/libre-right.jpg"></div> <div class="txt-box"><div class="text-glow-free">
                ...
                <p><span class="highlight">Tête :</span> Bergamote & Mandarine<br>
                   ...
                   <span class="highlight">Fond :</span> Vanille & Ambre Gris</p>
            </div></div>
        </div>
    </section>

    <section class="product-section gg-t" id="sec3">
        <div class="glow-center"></div>
        ...
        <div class="row">
            <div class="img-box"><img src="assets/gg-left.jpg"></div> <div class="txt-box"><div class="text-glow-free">
                <h3>LA FRAGRANCE</h3>
                <p>La douceur du jasmin et l'énivrante fève tonka révèlent le côté mystérieux de Good Girl.</p>
    ...
    <script>
        ...
        const colors = ['#4A90E2', '#D4AF37', '#1a4d99'];
        let currentIdx = 0;
